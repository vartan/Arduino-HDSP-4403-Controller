...
const int X[5] = {6,5,4,3,2};         // pixel columns pin
const int Y[7] = {13,12,11,10,9,8,7}; // pixel rows pins
const char* DISPLAY_MESSAGE = " Made By VARTAN";
...
void loop() {
  ...
  for(int column=0;column<5;column++) {
    ...
    delay(2); //seems to make the LED appear brighter with a 1ms delay here.
    for(int i=0;i<7;i++)
